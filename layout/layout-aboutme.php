...
<section id="aboutme" class="about" <?= $attributes; ?>>
	<div class="about__intro">
        ...
        ?>
          ...
          <div class="about__cv" >
					<p><a class='btn about__cv-btn' href="<?php echo $about_cv['url']; ?> " target="_blank"> <sm><?php echo $about_cv_text; ?> </sm><i class="cv_icon2 fa fa-arrow-circle-down"></i></a>
					<a class='btn about__cv-btn'  href="<?php echo $about_cv2['url']; ?>" target="_blank"><sm><?php echo $about_cv_text2; ?> </sm><i class=" cv_icon2 fa fa-arrow-circle-down"></i></a></p>
				</div>
				</div>
			</div><!--/.row -->
		</div><!--/.container -->
