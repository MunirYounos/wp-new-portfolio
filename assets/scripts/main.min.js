...
},b.BaseStatic.call(b.Facade),b.Facade.prototype=Object.create(b.Base.prototype),b.Facade.prototype.constructor=b.Facade,"object"==typeof exports&&"object"==typeof module?module.exports=b:"function"==typeof define&&define.amd?define(function(){return b}):"undefined"!=typeof a.mixitup&&"function"==typeof a.mixitup||(a.mixitup=a.mixItUp=b),(d=a.$||a.jQuery)&&d.fn.jquery&&b.registerJqPlugin(d),b.BaseStatic.call(b.constructor),b.NAME="mixitup",b.CORE_VERSION="3.1.7"}(window),jQuery(document).ready(function(a){a(".nav__list").atDropdown(),a(".nav-toggle").click(function(b){b.preventDefault(),a(".nav--mobile").toggleClass("is-open"),a("body").toggleClass("is-fixed")});var b=a(".slider__list");if(b.each(function(){var b=a(this).children().length>1,c=a(this).data("pause"),d=a(this).data("speed"),e=a(this).data("animation");a(this).owlCarousel({items:1,loop:b,autoplay:b,mouseDrag:b,touchDrag:b,autplaySpeed:d,autoplayTimeout:c,smartSpeed:d,navSpeed:d,nav:!1,dots:!1,animateOut:e})}),""!==window.location.hash.substr(1))var c="."+window.location.hash.substr(1);else var c="all";var d=a(".mixitup__wrapper");if(d.length){mixitup(d,{load:{filter:c},animation:{animateResizeTargets:!0}})}a(".js-zoom").fancybox({helpers:{title:{type:"inside"},overlay:{locked:!1},thumbs:{width:50,height:50,source:function(b){return a(b.element).data("thumbnail")}}}}),a(".entry table").wrap('<div class="table-wrapper">')}),$(window).load(function(){new Blazy({selector:".lazy",offset:100,successClass:"has-loaded"})});